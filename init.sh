...
EOF
  ...
  wget -qO- ${GH_PROXY}https://raw.githubusercontent.com/astralor/argo-nezha/main/template/backup.sh | sed '1,/^########/d' >> $WORK_DIR/backup.sh
...
EOF
    ...
    wget -qO- ${GH_PROXY}https://raw.githubusercontent.com/astralor/argo-nezha/main/template/restore.sh | sed '1,/^########/d' >> $WORK_DIR/restore.sh
  fi
...
EOF
  ...
  wget -qO- ${GH_PROXY}https://raw.githubusercontent.com/astralor/argo-nezha/main/template/renew.sh | sed '1,/^########/d' >> $WORK_DIR/renew.sh
